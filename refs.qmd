...
* Data management: Keeping your data organized and secure
    * The basics: [https://cghlewis.com/blog/project_beginning/](https://cghlewis.com/blog/project_beginning/)
    * All the details: [https://datamgmtinedresearch.com/](https://datamgmtinedresearch.com/)
...
* Gallery of plots: [https://r-graph-gallery.com/](https://r-graph-gallery.com/)

* ggplot reference: [https://ggplot2.tidyverse.org/reference/](https://ggplot2.tidyverse.org/reference/)

* Themes
    * Built-in: [https://ggplot2-book.org/themes#sec-themes](https://ggplot2-book.org/themes#sec-themes)
    * ggthemes package: [https://github.com/jrnold/ggthemes](https://github.com/jrnold/ggthemes)

* Shapes in ggplots: [https://r-graphics.org/RECIPE-SCATTER-SHAPES.html#discussion-28](https://r-graphics.org/RECIPE-SCATTER-SHAPES.html#discussion-28)
