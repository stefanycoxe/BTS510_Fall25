...
* The intercept ($b_0$) was 84.913, $t(197)$ = 11.991, $p$ < .0001. An individual who was *0 years old* **and** had a *non-emergency admission* is expected to have a pulse rate of 84.913. 
  * $\hat{Pulse} = 84.913 + 0.097 * 0 + 11.452 * 0 = 84.913$

## Interpretation

* The slope for age ($b_1$) was 0.097, $t(197)$ = 1.021, $p$ > .05. For each 1 year increase in age, the expected pulse rate increased by 0.097 points, **holding admission type constant**; this effect was not significant.

* The slope for admission type ($b_2$) was 11.452, $t(197)$ = 2.652, $p$ < .01. The difference in expected pulse rate between non-emergency admissions (0) and emergency admissions (1) was 11.452 points, **holding age constant**.
