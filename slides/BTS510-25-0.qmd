...
* This course covers *linear models* (i.e., regression) with a focus on **experimental studies**. 
  * Using and manipulating datasets, plotting data, estimation and uncertainty, linear regression, logistic regression, Poisson regression, and survival analysis.
...
- **Thursday at 10am**: Meet in person 
