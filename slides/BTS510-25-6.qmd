...
* Intercept = Expected `Pulse` value when `Age` = 0
  * $b_0$ = 96.048, $t(198)$ = 16.594, $p$ < .0001
  * `Pulse` for a person at `Age` = 0 is 96.048
* Slope = Expected change in `Pulse` for a 1 unit difference in `Age`
  * $b_1$ = 0.049, $t(198)$ = 0.526, $p$ > .05
  * For each 1 unit increase in `Age`, we expect `Pulse` to increase by ~~0.526~~ 0.049 points (NS)
...
* Non-significant effect
  * Thresholds: $b_1$ = 0.049, $t(198)$ = 0.526, $p$ > .05
  * Exact $p$-value: $b_1$ = 0.049, $t(198)$ = 0.526, $p$ = .599
  * Not significant: $b_1$ = 0.049, $t(198)$ = 0.526, NS
* Significant effect
  * Thresholds: $b_1$ = 10.628, $t(198)$ = 2.505, $p$ < .05
  * Exact $p$-value: $b_1$ = 10.628, $t(198)$ = 2.505, $p$ = .0131
...
* The intercept ($b_0$) was 96.048, $t(198)$ = 16.594, $p$ < .0001. An individual who was 0 years old is expected to have a pulse rate of 96.048. 
* The slope for age ($b_1$) was 0.049, $t(198)$ = 0.526, $p$ > .05. For each 1 year increase in age, the expected pulse rate increased by 0.049 points; this effect was not significant.
...
* The intercept ($b_0$) was 91.113, $t(198)$ = 25.049, $p$ < .0001. An individual who had a non-emergency admission is expected to have a pulse rate of 91.113. 

* The slope for type of admission ($b_1$) was 10.628, $t(198)$ = 2.505, $p$ < .05. The difference in expected pulse rate between non-emergency admissions (0) and emergency admissions (1) was 10.628 points. 
