...
* **Due Sunday, December 7 by end of day (midnight)**

* Complete the assignment in a Quarto (.qmd) document and render it to HTML and PDF. Email all 3 files (.qmd, .html, .pdf) to Stefany and Yujie.
...
3. For significant predictors, what are the predicted probabilities of acceptance at the mean, -1 SD, and +1 SD (holding all other predictors constant)?
...
6. For significant predictors, what are the predicted number of applications at the mean, -1 SD, and +1 SD (holding all other predictors constant)?